...
- Rush and Breakthrough stage HQs use the installed progression direction: Team 2 occupies the opening/attacker side and Team 1 the forward/defender side. Breakthrough objectives link their game-derived capture polygons and neutral alternate-spawn records into both Portal team spawn arrays. Active phase polygons are bound before the two compatibility boundary sectors so broad boundary shapes cannot reorder sector zones.

...
- Manhattan Bridge and Blackwell Fields suppress unclaimed bridge, rooftop, and box geometry that the generic classifier previously exposed as play boundaries. Empire State preserves all three exact game-authored HQ records, assigns the two Team 2 records to their shared authored HQ area, and keeps the larger combat zone separate.

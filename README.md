...
- Objective spawns are nested under their capture point with stable names. Wake Island Conquest joins each polygon to its installed `gem_capturepoint` root identity to restore the game's authored A-G lettering and includes its 11,251.8 m² G capture volume.

...
- Operations now links selected sector candidates to their exact HQ and CapturePoint arrays on Capstone and Tungsten. The installed layout also selects cross-partition content on Contaminated and Subsurface that their current layout exports omit; those two builds are refused until that content is imported. Candidate folder order is not presented as gameplay phase or battalion order.
